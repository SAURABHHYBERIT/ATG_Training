DROP TABLE IF EXISTS `dynamusic_tour_concerts`;
DROP TABLE IF EXISTS `dynamusic_tour_venue`;
DROP TABLE IF EXISTS `dynamusic_tour_artists`;
DROP TABLE IF EXISTS `dynamusic_fanclub`;
DROP TABLE IF EXISTS `dynamusic_poster`;
DROP TABLE IF EXISTS `dynamusic_tour`;
DROP TABLE IF EXISTS `dynamusic_newsongs_playlist`;
...
DROP TABLE IF EXISTS `dynamusic_classical_song`;
...
CREATE TABLE dynamusic_tour_concerts (
        ...
        primary key(tour_id, display_order)
);
