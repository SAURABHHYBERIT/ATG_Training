...
<HTML>
  <HEAD>
    <dsp:include page="common/head.jsp">
    	<dsp:param name="title" value="Dynamusic New Song" />
    </dsp:include>
  </HEAD>
  <BODY>
...
<!-- TBD: check for itemId -->
              ...
              <table cellpadding="10">
                ...
                <tr>
                  ...
                  <td>
                    <font face="Verdana,Geneva,Arial" size="-1">
                      <dsp:select bean="SongFormHandler.value.genre">
                      	<dsp:droplet name="/dynamusic/EnumForEach">
