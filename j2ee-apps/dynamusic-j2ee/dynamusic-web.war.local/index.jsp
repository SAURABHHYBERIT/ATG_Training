...
<head>
	<dsp:include page="common/head.jsp">
    	<dsp:param name="title" value="dynamusic-web JSP Index Page" />
    </dsp:include>
</head>
<body>
...
<%-- @version $Id: //edu/ILT-Courses/main/Extending/StudentFiles/Extending/setup/DynamusicEAP/j2ee-apps/dynamusic-j2ee/dynamusic-web.war/index.jsp#1 $$Change: 509061 $--%>
